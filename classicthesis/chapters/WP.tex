...
%By induction $\tau_{b \rightarrow j}$ is unsatisfiable so the only way to satisfy the formula is to set $j$ to the value of $j$ to satisfy $b$ thus not satisfying $a$.
\end{itemize}
\end{proof}
